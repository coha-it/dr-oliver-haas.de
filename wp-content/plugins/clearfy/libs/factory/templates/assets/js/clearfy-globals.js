...
(function($) {
	...
	$.wbcr_factory_templates_100.filters = $.wbcr_factory_templates_100.filters || $.wfactory_449.filters;
	//todo: Переопредление для совместимости со старыми версиями плагинов.
	$.wbcr_factory_templates_100.hooks = $.wbcr_factory_templates_100.hooks || $.wfactory_449.hooks;
	...
	$.wbcr_factory_templates_100.app = $.wbcr_factory_templates_100.app || {
		...
		showNotice: function(message, type) {
			...
			$([document.documentElement, document.body]).animate({
				 ...
				 * Пример регистрации хука $.wfactory_449.hooks.add('wbcr/factory_templates_100/updated',
				 * function(noticeId) {});
				 * @param {string} noticeId - id уведомления
				 */
				$.wfactory_449.hooks.run('wbcr/factory_templates_100/showed_notice', [noticeId]);
		...
		hideNotice: function(noticeId) {
			...
			el.fadeOut(500, function(e) {
				 ...
				 * @param {string} noticeId - id уведомления
				 */
				$.wfactory_449.hooks.run('wbcr/factory_templates_100/hidded_notice', [noticeId]);
